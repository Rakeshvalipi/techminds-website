        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="space-y-6">
              ...
              {[
                { icon: <Mail size={20} />, label: "Email", value: "info@techmindsit.com" },
                { icon: <Phone size={20} />, label: "Phone", value: "+91 9710499993" },
                { icon: <MapPin size={20} />, label: "Address", value: "Srinivasa Agraharam, Nellore, AP 524001" },
              ].map((info, i) => (
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="rounded-2xl overflow-hidden border border-border h-[400px]">
            <iframe
              title="TechMindsIt Location"
              src="https://www.google.com/maps?q=Srinivasa+Agraharam,+Nellore,+Andhra+Pradesh+524001&output=embed"
          ...
          <div className="flex justify-center gap-4 mt-4">
            <a
              href="https://www.google.com/maps/dir/?api=1&destination=Srinivasa+Agraharam,+Nellore,+Andhra+Pradesh+524001"
              target="_blank"
            ...
            <a
              href="https://www.google.com/maps/search/?api=1&query=Srinivasa+Agraharam,+Nellore,+Andhra+Pradesh+524001"
              target="_blank"
              rel="noopener noreferrer"
